...
School.create(
    ...
    department: '')
School.create(
    name: 'Msc In Advanced Computer Science(data Analytics) | University Of Leeds',
    url: 'http://www.engineering.leeds.ac.uk/computing/postgraduate/masters-advanced-computer-science/',
    program: 'Msc In Advanced Computer Science(data Analytics) | University Of Leeds',
    degree: 'Msc In Advanced Computer Science(data Analytics) | University Of Leeds',
    country: 'GB',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'B.S. Business Data Analytics | Arizona State University',
    url: 'http://wpcarey.asu.edu/undergraduate-degrees/data-analytics',
    program: 'B.S. Business Data Analytics | Arizona State University',
    degree: 'B.S. Business Data Analytics | Arizona State University',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Data Mining Program | University Of Central Florida',
    url: 'http://dms.stat.ucf.edu/',
    program: 'Data Mining Program | University Of Central Florida',
    degree: 'Data Mining Program | University Of Central Florida',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'BSc in Risk Management and Business Intelligence | Hong Kong University of Sci & Tech',
    url: 'http://www.rmbi.ust.hk/',
    program: 'BSc in Risk Management and Business Intelligence | Hong Kong University of Sci & Tech',
    degree: 'BSc in Risk Management and Business Intelligence | Hong Kong University of Sci & Tech',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Master of Science in Business Analytics | Naveen Jindal School of Management | UT Dallas',
    url: 'https://jindal.utdallas.edu/academic-programs/masters-programs/ms-in-business-analytics/',
    program: 'Master of Science in Business Analytics | Naveen Jindal School of Management | UT Dallas',
    degree: 'Master of Science in Business Analytics | Naveen Jindal School of Management | UT Dallas',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Data Analytics B.S. | The Ohio State University',
    url: 'https://data-analytics.osu.edu/',
    program: 'Data Analytics B.S. | The Ohio State University',
    degree: 'Data Analytics B.S. | The Ohio State University',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Education : Data Science : University of Rochester',
    url: 'http://www.rochester.edu/data-science/academics/index.html',
    program: 'Education : Data Science : University of Rochester',
    degree: 'Education : Data Science : University of Rochester',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'TU Dortmund - Data Analysis and Data Management B.Sc.',
    url: 'http://www.statistik.tu-dortmund.de/701.html',
    program: 'TU Dortmund - Data Analysis and Data Management B.Sc.',
    degree: 'TU Dortmund - Data Analysis and Data Management B.Sc.',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'TU Dortmund - Datascience M.Sc.',
    url: 'http://www.statistik.tu-dortmund.de/703.html',
    program: 'TU Dortmund - Datascience M.Sc.',
    degree: 'TU Dortmund - Datascience M.Sc.',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Artificial Intelligence - Maastricht University',
    ...
    program: 'Artificial Intelligence - Maastricht University',
    degree: 'Artificial Intelligence - Maastricht University',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Information Quality Program | University of Arkansas at Little Rock',
    url: 'http://ualr.edu/informationquality/',
    program: 'Information Quality Program | University of Arkansas at Little Rock',
    degree: 'Information Quality Program | University of Arkansas at Little Rock',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Data Science | Worcester Polytechnic Institute',
    url: 'http://www.wpi.edu/academics/datascience.html',
    program: 'Data Science | Worcester Polytechnic Institute',
    degree: 'Data Science | Worcester Polytechnic Institute',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Msba In Business Analytics | University Of Colorado',
    url: 'http://leeds.colorado.edu/ms#msba_business_analytics',
    program: 'Msba In Business Analytics | University Of Colorado',
    degree: 'Msba In Business Analytics | University Of Colorado',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Big Data Analytics Doctoral Degree | Online Doctorate | CTU',
    url: 'http://www.coloradotech.edu/degrees/doctorates/computer-science/big-data',
    program: 'Big Data Analytics Doctoral Degree | Online Doctorate | CTU',
    degree: 'Big Data Analytics Doctoral Degree | Online Doctorate | CTU',
    country: 'USA',
    state: '',
    online: true,
    oncampus: true,
    department: '')
School.create(
    name: 'Elmhurst College:  M.S. in Data Science',
    url: 'http://public.elmhurst.edu/data_science',
    program: 'Elmhurst College:  M.S. in Data Science',
    degree: 'Elmhurst College:  M.S. in Data Science',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Data Analysis - University of the Fraser Valley (UFV)',
    url: 'http://www.ufv.ca/math/data-analysis/',
    program: 'Data Analysis - University of the Fraser Valley (UFV)',
    degree: 'Data Analysis - University of the Fraser Valley (UFV)',
    country: 'CA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Queen\'s School of Business - Toronto',
    ...
    department: 'Business')
School.create(
    name: 'Data Science Specialisation Program, Paris',
    ...
    program: 'Data Science Specialisation Program, Paris',
    degree: 'Data Science Specialisation Program, Paris',
    country: 'FR',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Advanced Masters In Big Data | Telecom Paristech',
    url: 'http://www.telecom-paristech.fr/formation-continue/masteres-specialises/big-data.html',
    program: 'Advanced Masters In Big Data | Telecom Paristech',
    degree: 'Advanced Masters In Big Data | Telecom Paristech',
    country: 'FR',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Aarhus University | Industrial Phd In Big Data Analysis',
    url: 'http://icoa.au.dk/news/single/artikel/seeking-candidate-for-industrial-phd/',
    program: 'Aarhus University | Industrial Phd In Big Data Analysis',
    degree: 'Aarhus University | Industrial Phd In Big Data Analysis',
    country: 'DK',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'University Of Alberta | Msc In Statistical Machine Learning',
    url: 'https://www.cs.ualberta.ca/graduate-students/msc-program-requirements/statistical-machine-learning',
    program: 'University Of Alberta | Msc In Statistical Machine Learning',
    degree: 'University Of Alberta | Msc In Statistical Machine Learning',
    country: 'CA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Imperial College London | M.sc In Computing (machine Learning)',
    url: 'http://www3.imperial.ac.uk/computing/teaching/pg/mcsml',
    program: 'Imperial College London | M.sc In Computing (machine Learning)',
    degree: 'Imperial College London | M.sc In Computing (machine Learning)',
    country: 'GB',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Deakin University | Master Of Business Analytics',
    url: 'http://www.deakin.edu.au/future-students/courses/course.php?course=M760&stutype=local&keywords=information+systems',
    program: 'Deakin University | Master Of Business Analytics',
    degree: 'Deakin University | Master Of Business Analytics',
    country: 'AU',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Macquarie University, Sydney Australia | Master Of Data Science',
    url: 'http://courses.mq.edu.au/postgraduate/master/master-of-data-science',
    program: 'Macquarie University, Sydney Australia | Master Of Data Science',
    degree: 'Macquarie University, Sydney Australia | Master Of Data Science',
    country: 'AU',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'National University Of Ireland, Galway | Msc (information Systems Management)',
    url: 'http://www.nuigalway.ie/courses/taught-postgraduate-courses/information-systems-management.html',
    program: 'National University Of Ireland, Galway | Msc (information Systems Management)',
    degree: 'National University Of Ireland, Galway | Msc (information Systems Management)',
    country: 'IE',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Mykolas Romeris University | Business Informatics (graduate)',
    url: 'https://stdb.mruni.eu/studiju_programos_aprasas.php?id=2481&l=en',
    program: 'Mykolas Romeris University | Business Informatics (graduate)',
    degree: 'Mykolas Romeris University | Business Informatics (graduate)',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
...
School.create(
    ...
    department: '')
School.create(
    name: 'Master of Business Data Science (MBusDataSc), Otago Business School, University of Otago, New Zealand',
    url: 'http://www.otago.ac.nz/business/study/postgraduate/otago052118.html',
    program: 'Master of Business Data Science (MBusDataSc), Otago Business School, University of Otago, New Zealand',
    degree: 'Master of Business Data Science (MBusDataSc), Otago Business School, University of Otago, New Zealand',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'B.s. In Data Science | University Of San Francisco',
    url: 'http://usfca.edu/artsci/bsds/',
    program: 'B.s. In Data Science | University Of San Francisco',
    degree: 'B.s. In Data Science | University Of San Francisco',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
...
School.create(
    ...
    department: '')
School.create(
    name: 'CCSU - Data Mining',
    url: 'http://web.ccsu.edu/datamining/',
    program: 'CCSU - Data Mining',
    degree: 'CCSU - Data Mining',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Global Mism 21-month Track | Cmu',
    url: 'http://www.heinz.cmu.edu/school-of-information-systems-and-management/information-systems-management-mism/21-month-track/index.aspx',
    program: 'Global Mism 21-month Track | Cmu',
    degree: 'Global Mism 21-month Track | Cmu',
    country: 'USA',
    state: '',
    online: true,
    oncampus: true,
    department: '')
School.create(
    name: 'Loras College -  Academics - MBA Business Analytics',
    url: 'http://www.loras.edu/Academics/MBA-Business-Analytics.aspx',
    program: 'Loras College -  Academics - MBA Business Analytics',
    degree: 'Loras College -  Academics - MBA Business Analytics',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Mism Business Intelligence & Data Analytics (bida) | Cmu',
    ...
    program: 'Mism Business Intelligence & Data Analytics (bida) | Cmu',
    degree: 'Mism Business Intelligence & Data Analytics (bida) | Cmu',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'School of Information | Berkeley',
    url: 'http://www.ischool.berkeley.edu/',
    program: 'School of Information | Berkeley',
    degree: 'School of Information | Berkeley',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Data Science - College of Charleston',
    url: 'http://www.cofc.edu/academics/majorsandminors/data-science.php',
    program: 'Data Science - College of Charleston',
    degree: 'Data Science - College of Charleston',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'NYU Stern | Master of Science in Business Analytics',
    url: 'http://www.stern.nyu.edu/programs-admissions/global-degrees/business-analytics/index.htm',
    program: 'NYU Stern | Master of Science in Business Analytics',
    degree: 'NYU Stern | Master of Science in Business Analytics',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Ms Business Analytics | Michigan State University',
    url: 'http://broad.msu.edu/businessanalytics/',
    program: 'Ms Business Analytics | Michigan State University',
    degree: 'Ms Business Analytics | Michigan State University',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Master Of Science In Business Analytics | Lsu',
    url: 'http://businessanalytics.lsu.edu/',
    program: 'Master Of Science In Business Analytics | Lsu',
    degree: 'Master Of Science In Business Analytics | Lsu',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'University of San Francisco (USF) - Analytics',
    url: 'http://www.usfca.edu/analytics/',
    program: 'University of San Francisco (USF) - Analytics',
    degree: 'University of San Francisco (USF) - Analytics',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Computer Science M.s. Concentration In Data | Georgia Southern University',
    url: 'http://online.georgiasouthern.edu/index.php?link=grad_ComputerScience',
    program: 'Computer Science M.s. Concentration In Data | Georgia Southern University',
    degree: 'Computer Science M.s. Concentration In Data | Georgia Southern University',
    country: 'USA',
    state: '',
    online: true,
    oncampus: true,
    department: '')
School.create(
    name: 'Data Science Certificate | UW Professional & Continuing Education',
    url: 'http://www.pce.uw.edu/certificates/data-science.html',
    program: 'Data Science Certificate | UW Professional & Continuing Education',
    degree: 'Data Science Certificate | UW Professional & Continuing Education',
    country: 'USA',
    state: '',
    online: true,
    oncampus: true,
    department: '')
School.create(
    name: 'Data Mining Certificate - UC San Diego Extension',
    url: 'http://extension.ucsd.edu/programs/index.cfm?vAction=certDetail&vCertificateID=128&vStudyAreaID=14',
    program: 'Data Mining Certificate - UC San Diego Extension',
    degree: 'Data Mining Certificate - UC San Diego Extension',
    country: 'USA',
    state: '',
    online: true,
    oncampus: true,
    department: '')
School.create(
    name: 'MS-Business Analytics Program, University of Cincinnati',
    url: 'http://business.uc.edu/programs/graduate/msbana.html',
    program: 'MS-Business Analytics Program, University of Cincinnati',
    degree: 'MS-Business Analytics Program, University of Cincinnati',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Data Mining and Applications Graduate Certificate | Stanford University Online',
    url: 'http://scpd.stanford.edu/public/category/courseCategoryCertificateProfile.do?method=load&certificateId=1209602',
    program: 'Data Mining and Applications Graduate Certificate | Stanford University Online',
    degree: 'Data Mining and Applications Graduate Certificate | Stanford University Online',
    country: 'USA',
    state: '',
    online: true,
    oncampus: true,
    department: '')
School.create(
    name: 'Master of Science in Analytics: McCormick School of Engineering, Northwestern University',
    url: 'http://www.analytics.northwestern.edu/',
    program: 'Master of Science in Analytics: McCormick School of Engineering, Northwestern University',
    degree: 'Master of Science in Analytics: McCormick School of Engineering, Northwestern University',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'Online Master of Science in Predictive Analytics, Northwestern University School of Continuing Studies',
    url: 'http://www.scs.northwestern.edu/program-areas/graduate/predictive-analytics/index.php',
    program: 'Online Master of Science in Predictive Analytics, Northwestern University School of Continuing Studies',
    degree: 'Online Master of Science in Predictive Analytics, Northwestern University School of Continuing Studies',
    country: 'USA',
    state: '',
    online: true,
    oncampus: true,
    department: '')
School.create(
    name: 'North Carolina State University | M.s. Analytics',
    url: 'http://analytics.ncsu.edu/?page_id=1799',
    program: 'North Carolina State University | M.s. Analytics',
    degree: 'North Carolina State University | M.s. Analytics',
    country: 'USA',
    state: '',
    online: false,
    oncampus: true,
    department: '')
School.create(
    name: 'CAS in Data Science - iSchool - The School of Information Studies - Syracuse University',
    url: 'http://ischool.syr.edu/future/cas/datascience.aspx',
    program: 'CAS in Data Science - iSchool - The School of Information Studies - Syracuse University',
    degree: 'CAS in Data Science - iSchool - The School of Information Studies - Syracuse University',
    country: 'USA',
    state: '',
    online: true,
    oncampus: true,
